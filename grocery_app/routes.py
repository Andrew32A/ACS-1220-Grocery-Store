...
def new_store():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.store_detail', store_id=new_grocery_store.id)) # might need to change grocery_id later
...
def new_item():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.item_detail', item_id=new_grocery_item.id)) # same as above
...
def store_detail(store_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.store_detail', store_id=store.id)) # might need to change grocery_id later
...
def item_detail(item_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.item_detail', item_id=item.id)) # same as above
